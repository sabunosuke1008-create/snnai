"""Generate the Kaggle ablation notebook (environment/kaggle_ablation/notebook.ipynb).

The notebook runs a 5-pattern ablation (P1 baseline .. P5 all-features) with
fair parameter matching and optional knowledge distillation. A single `LIGHT`
flag switches between a cheap gate run (1 seed, tiny dims) and the full
3-seed run, per the "light first, then full" Kaggle testing strategy.
"""
import json
import os
