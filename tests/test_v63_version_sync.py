...
def test_kernel_metadata_title_contains_version():
    ...
    assert any(v in data["title"] for v in ["v6-4-0", "v6.4.0", "v6-4-1", "v6.4.1", "v6-4-2", "v6.4.2", "v6-4-3", "v6.4.3", "v6-4-4", "v6.4.4", "v6-4-5", "v6.4.5", "v6-4-6", "v6.4.6", "v6-5-0", "v6.5.0", "v6-5-1", "v6.5.1", "v6-5-2", "v6.5.2", "v6-5-3", "v6.5.3", "v6-5-4", "v6.5.4"])


def test_version_is_release():
    assert snnai.__version__ == "v6.5.4"
